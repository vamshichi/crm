          ...
          return (
            ...
            >
              <div className="flex flex-col sm:flex-row justify-between items-center gap-2 mb-2">
                <h3 className="text-2xl font-semibold mb-4 text-center border-b pb-2 flex-1">{dept.name} Department</h3>
                <button
                    ...
                    <div className="overflow-x-auto w-full">
                      <table className="w-full border-collapse border border-gray-300">
                        <thead className="bg-gray-200">
                          <tr>
                            <th className="border p-1 sm:p-2 text-left text-xs sm:text-sm whitespace-nowrap">
                              Employee
                            </th>
                            <th className="border p-1 sm:p-2 text-center text-xs sm:text-sm whitespace-nowrap">
                              Total
                            </th>
                          ...
                          {employeeDetails.map((emp) => {
                            ...
                            return (
                              <tr key={emp.id} className="hover:bg-gray-50">
                                ...
                                <td className="border p-1 sm:p-2 text-center text-xs sm:text-sm whitespace-nowrap">
                                  {totalLeads}
                                </td>
